...
RUN apt-get update && \
    ...
    build-essential p7zip-full sqlite3 libunarr-dev qtdeclarative5-dev qt5-image-formats-plugins libpoppler-qt5-dev libpoppler-qt5-1 libqt5sql5 libqt5sql5-sqlite libqt5network5 libqt5gui5 libqt5core5a
